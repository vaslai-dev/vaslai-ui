<template>
  <!-- Breadcrumb -->
  <nav
    class="justify-between px-4 py-6 text-gray-700 p rounded-lg sm:flex sm:px-5"
    ...
    <!-- <ol class="inline-flex items-center mb-3 space-x-1 md:space-x-3 sm:mb-0">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span
            class="mx-1 text-sm font-medium text-gray-500 md:mx-2 dark:text-gray-400"
            >Issue #312</span
          ><span
